...
def main():
    ...
    group_post_training.add_argument('--dataset_path', type=str, default="datasets/lm_post_training/lm_post_training/모두의말뭉치", help="데이터 셋 경로(기본값: datasets/lm_post_training/lm_post_training/모두의말뭉치)")
